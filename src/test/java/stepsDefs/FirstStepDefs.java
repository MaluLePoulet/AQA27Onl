...
public class FirstStepDefs {
    ...
    public void userEntersValues() {
        System.out.println("Пользователь вводит логин");
    }
    ...
    @Then("кнопка логина становится активной")
    public void isLoginButtonСlickable() {
        Assert.assertTrue(true, "Поле логина не отображается");
    }

    @Then("кнопка логина не становится активной")
    public void isLoginNotButtonСlickable() {
        Assert.assertTrue(true,"Поле логина отображается");
    }
    ...
    @Then("^all elements \"(are|are not)\" visible$")
    public void elementsVisibility1() {
        System.out.println();
    }
